...
public class SmokeTests_NewTours_Module1Test extends BaseTest {
	...
	public void SmokeTests_NewTours_Module1_TC1() {
		...
		try {
			...
			if (Browser.getPageTitle().contentEquals("Login: Mercury Toursss")) {
				...
				funcLogTestStep(TEST_FAILED, "Page Title is NOT 'Login: Mercury Tourss' Actual: " + Browser.getPageTitle());
			}
	...
	public void SmokeTests_NewTours_Module1_TC2() {
		...
		try {
			...
			if (Browser.getPageTitle().contentEquals("Welcome: Mercury Tours")) {
				funcLogTestStep(TEST_PASSED, "Page Title is 'Welcome: Mercury Tours' ");
			} else {
				funcLogTestStep(TEST_FAILED, "Page Title is NOT 'Login: Mercury Tours' Actual: " + Browser.getPageTitle());
			}
